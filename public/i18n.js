(function () {
  ...
  const text = {
    ...
    'Why Harmony Retreats': '为什么选择和旅出行',
    ...
    'Every Harmony Retreats itinerary weaves three threads — medical precision, traditional restoration, and the slow rhythm of Chinese landscape.': '每一条和旅出行路线，都把精准医疗、传统康养与中国山水的舒缓节奏编织在一起。',
    'Every Harmony Retreats itinerary weaves three threads: medical precision, traditional restoration, and the slow rhythm of Chinese landscape.': '每一条和旅出行路线，都把精准医疗、传统康养与中国山水的舒缓节奏编织在一起。',
    ...
    'About Harmony Retreats': '关于和旅出行',
    'A small team. Fifteen years of careful relationships.': '一个小团队，十五年深耕关系。',
    'Harmony Retreats is held by a tight group of medical, wellness and travel curators based in Hangzhou, Shanghai and Chengdu. We design and accompany every itinerary ourselves.': '和旅出行由一支分布在杭州、上海和成都的医疗、康养与旅行策展团队共同运营。每条路线都由我们亲自设计并陪同落地。',
    '— Our Story': '— 我们的故事',
    ...
    'I agree that Harmony Retreats may contact me about my inquiry. We will never share your details.': '我同意和旅出行为本次咨询联系我。我们不会向第三方分享你的信息。',
    'Send Inquiry →': '提交咨询 →',
